...
class Rentals_model extends App_Model {
    ...
    public function delete_rental_agreement_details($id) {
        // Restore Inventory Status before deleting
    ...
    public function get_calendar_rental_details() {
        // Joins ensure we get Client Name and Serial Number for the calendar tooltip
        return $this->db->select('
            ...
            ->where('a.status !=', 1) // Exclude Drafts if 1 is draft
            ->get()->result();
    }
}