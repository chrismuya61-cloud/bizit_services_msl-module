      ...
      <div class="col-md-12">
        ...
        <div class="panel_s">
          <div class="panel-body _buttons">
            <?php if ($service_info->status == 0 || 1==1): ?>
        ...
        <div class="panel_s">
          <div class="panel-body">
            ...
            <?php if ($service_info->item_type == 'Level') { ?>
              <div class="form-section table-responsive current">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="_total" style="text-align:center; font-weight:500;">BACKSIGHT A</th>
                        <th class="desc" style="text-align:center; font-weight:500;">FORESIGHT A</th>
                        <th class="_total" style="text-align:center; font-weight:500;">d1(mm) <br> Elevation (mm)</th>
                        <th class="desc" style="text-align:center; font-weight:500;">Residual from <br> Mean (mm)</th>
                        <th class="_total" style="text-align:center; font-weight:500;">Squared <br> Residuals (mm)</th>
                        <th class="_total" style="text-align:center; font-weight:500;">BACKSIGHT B</th>
                        <th class="desc" style="text-align:center; font-weight:500;">FORESIGHT B</th>
                        <th class="_total" style="text-align:center; font-weight:500;">d2(mm) <br> Elevation (mm)</th>
                        <th class="desc" style="text-align:center; font-weight:500;">Residual from <br> Mean (mm)</th>
                        <th class="_total" style="text-align:center; font-weight:500;">Squared <br> Residuals (mm)</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $i_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $i_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_i; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $i_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $i_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_ii; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $ii_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ii_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_iii; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $ii_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ii_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_iv; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $iii_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iii_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_v; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $iii_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iii_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_vi; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $iv_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iv_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_vii; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $iv_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iv_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_viii; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $v_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $v_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_ix; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $v_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $v_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_x; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $vi_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vi_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xi; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $vi_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vi_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xii; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $vii_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vii_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xiii; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $vii_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vii_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xiv; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $viii_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $viii_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xv; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $viii_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $viii_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xvi; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $ix_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ix_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xvii; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $ix_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ix_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xviii; ?></td>
                      ...
                      <tr>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $x_backsight_a; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $x_foresight_b; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xix; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $x_backsight_c; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $x_foresight_d; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_xx; ?></td>
                ...
                <div class="form-section table-responsive">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">1</td>
                        <td class="_total" style="text-align:center;"><?php echo $i_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $i_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_1; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $i_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $i_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_2; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">2</td>
                        <td class="_total" style="text-align:center;"><?php echo $ii_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ii_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_3; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $ii_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ii_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_4; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">3</td>
                        <td class="_total" style="text-align:center;"><?php echo $iii_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iii_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_5; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $iii_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iii_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_6; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">4</td>
                        <td class="_total" style="text-align:center;"><?php echo $iv_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iv_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_7; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $iv_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $iv_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_8; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">5</td>
                        <td class="_total" style="text-align:center;"><?php echo $v_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $v_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_9; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $v_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $v_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_10; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">6</td>
                        <td class="_total" style="text-align:center;"><?php echo $vi_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vi_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_11; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $vi_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vi_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_12; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">7</td>
                        <td class="_total" style="text-align:center;"><?php echo $vii_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vii_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_13; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $vii_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $vii_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_14; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">8</td>
                        <td class="_total" style="text-align:center;"><?php echo $viii_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $viii_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_15; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $viii_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $viii_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_16; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">9</td>
                        <td class="_total" style="text-align:center;"><?php echo $ix_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ix_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_17; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $ix_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $ix_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_18; ?></td>
                      ...
                      <tr>
                        <td class="desc" style="text-align:center; font-weight:500;">10</td>
                        <td class="_total" style="text-align:center;"><?php echo $x_backsight_e; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $x_foresight_f; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_19; ?></td>
                        ...
                        <td class="_total" style="text-align:center;"><?php echo $x_backsight_g; ?></td>
                        <td class="desc" style="text-align:center;"><?php echo $x_foresight_h; ?></td>
                        <td class="_total" style="text-align:center;"><?php echo $diff_20; ?></td>
              ...
              <div class="form-section table-responsive current">
                ...
                <table class="table table-bordered table-striped dataTable">
                  <thead>
                    <tr>
                      <th></th>
                      <th colspan="2" style="text-align:center; font-weight:500;" class="_total">HORIZONTAL CIRCLE INDEX ERROR</th>
                    ...
                    <tr>
                      ...
                      <th class="_total" style="text-align:center; font-weight:500;">START A</th>
                      <th class="_total" style="text-align:center; font-weight:500;">END B</th>
                  ...
                  <tbody>
                    ...
                    $i_edm_a_1 = number_format(round($calibration_info->i_edm_a_1 ?? 0, 3), 4);
                    $i_edm_a_2 = number_format(round($calibration_info->i_edm_a_2 ?? 0, 3), 4);
                    $i_edm_a_3 = number_format(round($calibration_info->i_edm_a_3 ?? 0, 3), 4);
                    $f_i_edm_a = ($i_edm_a_1 + $i_edm_a_2 + $i_edm_a_3) / 3;

                    $i_edm_b_1 = number_format(round($calibration_info->i_edm_b_3 ?? 0, 3), 4);
                    $i_edm_b_2 = number_format(round($calibration_info->i_edm_b_4 ?? 0, 3), 4);
                    $i_edm_b_3 = number_format(round($calibration_info->i_edm_b_3 ?? 0, 3), 4);
                    $f_i_edm_b = ($i_edm_b_1 + $i_edm_b_2 + $i_edm_b_3) / 3;

                    $ii_edm_a_1 = number_format(round($calibration_info->ii_edm_a_1 ?? 0, 3), 4);
                    $ii_edm_a_2 = number_format(round($calibration_info->ii_edm_a_2 ?? 0, 3), 4);
                    $ii_edm_a_3 = number_format(round($calibration_info->ii_edm_a_3 ?? 0, 3), 4);
                    $f_ii_edm_a = ($ii_edm_a_1 + $ii_edm_a_2 + $ii_edm_a_3) / 3;

                    $ii_edm_b_1 = number_format(round($calibration_info->ii_edm_b_1 ?? 0, 3), 4);
                    $ii_edm_b_2 = number_format(round($calibration_info->ii_edm_b_2 ?? 0, 3), 4);
                    $ii_edm_b_3 = number_format(round($calibration_info->ii_edm_b_3 ?? 0, 3), 4);
                    ...
                    if ($d_error_v_b1_5 > $t_v_a_10 && $d_error_v_b1_5 > $t_v_a_10) {
                      // Fail case
                      $result2 = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(255, 0, 0, 0.3); color: black;"><b>FAILED</b></td>';
                    } else {
                      // Pass case
                      $result2 = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(0, 255, 0, 0.3); color: black;"><b>PASSED</b></td>';
                    }
                    ...
                    <tr>
                      ...
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($i_h_a); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($i_h_b); ?></td>
                    ...
                    <tr>
                      ...
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($ii_h_a); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($ii_h_b); ?></td>
                    ...
                    <tr>
                      ...
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($sum_h_a); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($sum_h_b); ?></td>
                    ...
                    <tr>
                      ...
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($d_error_h_a); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($d_error_h_b); ?></td>
              ...
              <div class="form-section table-responsive">
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <tbody>
                    ...
                    $i_edm_a_12 = number_format(round($calibration_info->i_edm_a_12 ?? 0, 3), 4);
                    $i_edm_a_22 = number_format(round($calibration_info->i_edm_a_22 ?? 0, 3), 4);
                    $i_edm_a_32 = number_format(round($calibration_info->i_edm_a_32 ?? 0, 3), 4);
                    $f_i_edm_a2 = ($i_edm_a_12 + $i_edm_a_22 + $i_edm_a_32) / 3;

                    $i_edm_b_12 = number_format(round($calibration_info->i_edm_b_12 ?? 0, 3), 4);
                    $i_edm_b_22 = number_format(round($calibration_info->i_edm_b_22 ?? 0, 3), 4);
                    $i_edm_b_32 = number_format(round($calibration_info->i_edm_b_32 ?? 0, 3), 4);
                    $f_i_edm_b2 = ($i_edm_b_12 + $i_edm_b_22 + $i_edm_b_32) / 3;

                    $ii_edm_a_12 = number_format(round($calibration_info->ii_edm_a_12 ?? 0, 3), 4);
                    $ii_edm_a_22 = number_format(round($calibration_info->ii_edm_a_22 ?? 0, 3), 4);
                    $ii_edm_a_32 = number_format(round($calibration_info->ii_edm_a_32 ?? 0, 3), 4);
                    $f_ii_edm_a2 = ($ii_edm_a_12 + $ii_edm_a_22 + $ii_edm_a_32) / 3;

                    $ii_edm_b_12 = number_format(round($calibration_info->ii_edm_b_12 ?? 0, 3), 4);
                    $ii_edm_b_22 = number_format(round($calibration_info->ii_edm_b_22 ?? 0, 3), 4);
                    $ii_edm_b_32 = number_format(round($calibration_info->ii_edm_b_32 ?? 0, 3), 4);
                    ...
                    if ($d_error_v_b1_6 > $t_v_a_10 && $d_error_v_b1_6 > $t_v_a_10) {
                      // Fail case
                      $result3 = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(255, 0, 0, 0.3); color: black;"><b>FAILED</b></td>';
                    } else {
                      // Pass case
                      $result3 = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(0, 255, 0, 0.3); color: black;"><b>PASSED</b></td>';
                    }
                    ?>
                    <tr>
                      <td class="desc" style="text-align:center; font-weight:500;"><b>I</b></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($t_h_a); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($t_h_b); ?></td>
                    ...
                    <tr>
                      <td class="desc" style="text-align:center; font-weight:500;"><b>II</b></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($tt_h_a); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($tt_h_b); ?></td>
                    ...
                    <tr>
                      <td class="desc" style="text-align:center; font-weight:500;"><b>SUM(I+II)</b></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($sum_h_a2); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($sum_h_b2); ?></td>
                    ...
                    <tr>
                      <td class="desc" style="text-align:center; font-weight:500;"><b>DOUBLE ERROR</b></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($d_error_h_a2); ?></td>
                      <td class="_total" style="text-align:center;"><?php echo dec2dms_full($d_error_h_b2); ?></td>
            ...
            <?php } else if ($service_info->item_type == 'Theodolite') { ?>
              ...
              <table class="table table-bordered table-striped dataTable">
                ...
                <tbody>
                  ...
                  $i_edm_a_1 = number_format(round($calibration_info->i_edm_a_1, 3), 4);
                  $i_edm_a_2 = number_format(round($calibration_info->i_edm_a_2, 3), 4);
                  $i_edm_a_3 = number_format(round($calibration_info->i_edm_a_3, 3), 4);
                  $f_i_edm_a = ($i_edm_a_1 + $i_edm_a_2 + $i_edm_a_3) / 3;

                  $i_edm_b_3 = number_format(round($calibration_info->i_edm_b_3, 3), 4);
                  $i_edm_b_4 = number_format(round($calibration_info->i_edm_b_4, 3), 4);
                  $i_edm_b_3 = number_format(round($calibration_info->i_edm_b_3, 3), 4);
                  $f_i_edm_b = ($i_edm_b_1 + $i_edm_b_2 + $i_edm_b_3) / 3;

                  $ii_edm_a_1 = number_format(round($calibration_info->ii_edm_a_1, 3), 4);
                  $ii_edm_a_2 = number_format(round($calibration_info->ii_edm_a_2, 3), 4);
                  $ii_edm_a_3 = number_format(round($calibration_info->ii_edm_a_3, 3), 4);
                  $f_ii_edm_a = ($ii_edm_a_1 + $ii_edm_a_2 + $ii_edm_a_3) / 3;

                  $ii_edm_b_1 = number_format(round($calibration_info->ii_edm_b_1, 3), 4);
                  $ii_edm_b_2 = number_format(round($calibration_info->ii_edm_b_2, 3), 4);
                  $ii_edm_b_3 = number_format(round($calibration_info->ii_edm_b_3, 3), 4);
                  $f_ii_edm_b = ($ii_edm_b_1 + $ii_edm_b_2 + $ii_edm_b_3) / 3;
                  ...
                  if ($d_error_v_a_2 > $th_v_a_9 && $d_error_v_a > $th_v_a_9) {
                    // Fail case
                    $result = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(255, 0, 0, 0.3); color: black;"><b>FAILED</b></td>';
                  } else {
                    // Pass case
                    $result = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(0, 255, 0, 0.3); color: black;"><b>PASSED</b></td>';
                  }
                  ?>
                  <tr>
                    <td class="desc" style="text-align:center; font-weight:500;"><b>I</b></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($th_h_a); ?></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($th_h_b); ?></td>
                  ...
                  <tr>
                    <td class="desc" style="text-align:center; font-weight:500;"><b>II</b></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($thh_h_a); ?></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($thh_h_b); ?></td>
              ...
              <table class="table table-bordered table-striped dataTable">
                ...
                <tbody>
                  ...
                  $i_edm_b_1 = number_format(round($calibration_info->i_edm_b_1, 3), 4);
                  $i_edm_b_2 = number_format(round($calibration_info->i_edm_b_2, 3), 4);
                  $i_edm_b_3 = number_format(round($calibration_info->i_edm_b_3, 3), 4);
                  $f_i_edm_b = ($i_edm_b_1 + $i_edm_b_2 + $i_edm_b_3) / 3;
                  ...
                  if ($d_error_v_b1_4 > $th_v_a_9 && $d_error_v_b1_4 > $th_v_a_9) {
                    // Fail case
                    $result1 = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(255, 0, 0, 0.3); color: black;"><b>FAILED</b></td>';
                  } else {
                    // Pass case
                    $result1 = '<td colspan="4" class="_total" style="text-align:center; background-color: rgba(0, 255, 0, 0.3); color: black;"><b>PASSED</b></td>';
                  }
                  ?>
                  <tr>
                    <td class="desc" style="text-align:center; font-weight:500;"><b>I</b></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($th_h_a1); ?></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($th_h_b1); ?></td>
                  ...
                  <tr>
                    <td class="desc" style="text-align:center; font-weight:500;"><b>II</b></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($thh_h_a1); ?></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($thh_h_b1); ?></td>
                  ...
                  <tr>
                    <td class="desc" style="text-align:center; font-weight:500;"><b>SUM(I+II)</b></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($sum_h_a1); ?></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($sum_h_b1); ?></td>
                  ...
                  <tr>
                    <td class="desc" style="text-align:center; font-weight:500;"><b>Double Error</b></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($d_error_h_a1); ?></td>
                    <td class="_total" style="text-align:center;"><?php echo dec2dms_full($d_error_h_b1); ?></td>
              ...
              <div class="form-section current table-responsive">
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <th colspan="2" style="text-align:center; font-weight:500; float:right;">MEASUREMENTS</th>
                      <td></td>
                  ...
                  <tbody>
                    ...
                    $sumValue17 = round(($sumValue1a + $sumValue2a + $sumValue3a + $sumValue4a + $sumValue5a) / 5, 4);
                    $sumValue18 = round(($sumValue6a + $sumValue7a + $sumValue8a + $sumValue9a + $sumValue10a) / 5, 4);

                    $sumValue19 = round(($sumValue17) / 5, 4);
                    $sumValue20 = round(($sumValue18) / 5, 4);
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_a_1, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_a_2, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_a_3, 4); ?></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting1a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting1b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting1c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue1a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue1b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue1c, 4); ?></td>
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting2a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting2b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting2c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue2a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue2b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue2c, 4); ?></td>
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting3a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting3b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting3c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue3a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue3b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue3c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting4a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting4b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting4c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue4a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue4b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue4c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;">1</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting5a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting5b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting5c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue5a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue5b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue5c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting6a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting6b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting6c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue6a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue6b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue6c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting7a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting7b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting7c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue7a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue7b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue7c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting8a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting8b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting8c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue8a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue8b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue8c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting9a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting9b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting9c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue9a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue9b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue9c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting10a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting10b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting10c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue10a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue10b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue10c, 4); ?></td>
                    </tr>
                    <tr>
                      <td>Stop Time</td>
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <tbody>
                    ...
                    $sumValue17 = round(($sumValue1b + $sumValue2b + $sumValue3b + $sumValue4b + $sumValue5b) / 5, 4);
                    $sumValue18 = round(($sumValue6b + $sumValue7b + $sumValue8b + $sumValue9b + $sumValue10b) / 5, 4);
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_b_1, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_b_2); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_b_3); ?></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting11a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting11b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting11c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue11a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue11b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue11c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting12a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting12b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting12c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue12a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue12b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue12c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting13a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting13b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting13c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue13a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue13b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue13c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting14a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting14b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting14c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue14a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue14b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue14c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;">2</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting15a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting15b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting15c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue15a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue15b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue15c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting16a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting16b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting16c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue16a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue16b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue16c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting17a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting17b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting17c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue17a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue17b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue17c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting18a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting18b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting18c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue18a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue18b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue18c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting19a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting19b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting19c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue19a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue19b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue19c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting20a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting20b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting20c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue20a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue20b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue20c, 4); ?></td>
                    </tr>
                    <tr>
                      <td>Stop Time</td>
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <tbody>
                    ...
                    $sumValue11a = round(($i_v_a_1 + $iii_v_a_1 + $v_v_a_1 + $vii_v_a_1 + $xi_v_a_1 + $i_v_b_1 + $iii_v_b_1 + $v_v_b_1 + $vii_v_b_1 + $xi_v_b_1 + $i_v_c_1 + $iii_v_c_1 + $v_v_c_1 + $vii_v_c_1 + $xi_v_c_1) / 15, 4);
                    $sumValue12a = round(($i_v_a_2 + $iii_v_a_2 + $v_v_a_2 + $vii_v_a_2 + $xi_v_a_2 + $i_v_b_2 + $iii_v_b_2 + $v_v_b_2 + $vii_v_b_2 + $xi_v_b_2 + $i_v_c_2 + $iii_v_c_2 + $v_v_c_2 + $vii_v_c_2 + $xi_v_c_2) / 15, 4);
                    $sumValue13a = round(($i_v_a_3 + $iii_v_a_3 + $v_v_a_3 + $vii_v_a_3 + $xi_v_a_3 + $i_v_b_3 + $iii_v_b_3 + $v_v_b_3 + $vii_v_b_3 + $xi_v_b_3 + $i_v_c_3 + $iii_v_c_3 + $v_v_c_3 + $vii_v_c_3 + $xi_v_c_3) / 15, 4);

                    $sumValue14a = round(($ii_v_a_1 + $iv_v_a_1 + $vi_v_a_1 + $viii_v_a_1 + $x_v_a_1 + $ii_v_b_1 + $iv_v_b_1 + $vi_v_b_1 + $viii_v_b_1 + $x_v_b_1 + $ii_v_c_1 + $iv_v_c_1 + $vi_v_c_1 + $viii_v_c_1 + $x_v_c_1) / 15, 4);
                    $sumValue15a = round(($ii_v_a_2 + $iv_v_a_2 + $vi_v_a_2 + $viii_v_a_2 + $x_v_a_2 + $ii_v_a_2 + $iv_v_a_2 + $vi_v_a_2 + $viii_v_a_2 + $x_v_a_2 + $ii_v_c_2 + $iv_v_c_2 + $vi_v_c_2 + $viii_v_c_2 + $x_v_c_2) / 15, 4);
                    $sumValue16a = round(($ii_v_a_3 + $iv_v_a_3 + $vi_v_a_3 + $viii_v_a_3 + $x_v_a_3 + $ii_v_b_3 + $iv_v_b_3 + $vi_v_b_3 + $viii_v_b_3 + $x_v_b_3 + $ii_v_c_3 + $iv_v_c_3 + $vi_v_c_3 + $viii_v_c_3 + $x_v_c_3) / 15, 4);
                    ...
                    // $sumValue19 = round(($sumValue17) / 15, 4);
                    // $sumValue20 = round(($sumValue18) / 15, 4);
                    $sumValue19 = round(($sumValue17) / 15, 4);
                    // $sumValue19 = 19.995;
                    $sumValue20 = round(($sumValue18) / 15, 4);
                    // $sumValue20 = 0.028;
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_c_1, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_c_2); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_c_3); ?></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting21a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting21b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting21c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue21a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue21b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue21c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting22a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting22b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting22c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue22a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue22b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue22c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting23a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting23b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting23c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue23a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue23b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue23c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting24a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting24b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting24c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue24a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue24b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue24c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;">3</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting25a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting25b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting25c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue25a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue25b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue25c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting26a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting26b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting26c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue26a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue26b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue26c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting27a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting27b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting27c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue27a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue27b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue27c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting28a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting28b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting28c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue28a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue28b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue28c, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting29a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting29b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting29c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue29a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue29b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue29c, 4); ?></td>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting30a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting30b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting30c, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue30a, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue30b, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue30c, 4); ?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <th></th>
                      <th></th>
                      <th colspan="3" class="hide">SUM</th>
                    </tr>
                    <tr>
                      <td></td>
                      <td></td>
                      ...
                      <th colspan="2" class="hide">SUM</th>
                      <td></td>
                      <td></td>
                      <td></td>
              ...
              <div class="form-section table-responsive">
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <tbody>
                    ...
                    $sumValue17 = round(($sumValue1aa + $sumValue2aa + $sumValue3aa + $sumValue4aa + $sumValue5aa) / 5, 4);
                    $sumValue18 = round(($sumValue6aa + $sumValue7aa + $sumValue8aa + $sumValue9aa + $sumValue10aa) / 5, 4);
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_aa_1, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_aa_2); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_aa_3); ?></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting1aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting1bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting1cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue1aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue1bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue1cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">2</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting2aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting2bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting2cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue2aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue2bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue2cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">3</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting3aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting3bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting3cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue3aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue3bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue3cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">4</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting4aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting4bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting4cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue4aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue4bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue4cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">5</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting5aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting5bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting5cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue5aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue5bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue5cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">6</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting6aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting6bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting6cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue6aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue6bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue6cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">7</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting7aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting7bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting7cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue7aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue7bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue7cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">8</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting8aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting8bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting8cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue8aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue8bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue8cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">9</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting9aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting9bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting9cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue9aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue9bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue9cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">10</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting10aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting10bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting10cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue10aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue10bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue10cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td>Stop Time</td>
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <tbody>
                    ...
                    $sumValue17 = round(($sumValue1bb + $sumValue2bb + $sumValue3bb + $sumValue4bb + $sumValue5bb) / 5, 4);
                    $sumValue18 = round(($sumValue6bb + $sumValue7bb + $sumValue8bb + $sumValue9bb + $sumValue10bb) / 5, 4);
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_bb_1, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_bb_2); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_bb_3); ?></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting11aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting11bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting11cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue11aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue11bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue11cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">12</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting12aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting12bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting12cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue12aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue12bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue12cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">13</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting13aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting13bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting13cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue13aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue13bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue13cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">14</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting14aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting14bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting14cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue14aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue14bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue14cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;">2</td>
                      <td class="" style="text-align:center;">15</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting15aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting15bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting15cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue15aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue15bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue15cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">16</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting16aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting16bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting16cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue16aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue16bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue16cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">17</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting17aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting17bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting17cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue17aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue17bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue17cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">18</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting18aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting18bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting18cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue18aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue18bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue18cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">19</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting19aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting19bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting19cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue19aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue19bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue19cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">20</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting20aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting20bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting20cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue20aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue20bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue20cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td>Stop Time</td>
                ...
                <table class="table table-bordered table-striped dataTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;">1</td>
                      <td class="" style="text-align:center;"><?php echo round($i_v_cc_1, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_cc_2); ?></td>
                      <td class="" style="text-align:center;"><?php echo ($i_v_cc_3); ?></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting21aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting21bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting21cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue21aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue21bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue21cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">22</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting22aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting22bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting22cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue22aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue22bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue22cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">23</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting23aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting23bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting23cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue23aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue23bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue23cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">24</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting24aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting24bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting24cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue24aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue24bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue24cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;">3</td>
                      <td class="" style="text-align:center;">25</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting25aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting25bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting25cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue25aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue25bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue25cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">26</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting26aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting26bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting26cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue26aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue26bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue26cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">27</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting27aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting27bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting27cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue27aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue27bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue27cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">28</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting28aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting28bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting28cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue28aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue28bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue28cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">29</td>
                      ...
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting29aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting29bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting29cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue29aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue29bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue29cc, 4); ?></td>
                    </tr>
                    <tr>
                      <td class="" style="text-align:center;"></td>
                      <td class="" style="text-align:center;">30</td>
                      ...
                      <td class="" style="text-align:center;"><?php echo round($residualEasting30aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting30bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($residualEasting30cc, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue30aa, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue30bb, 4); ?></td>
                      <td class="" style="text-align:center;"><?php echo round($squaredValue30cc, 4); ?></td>
                    </tr>
                    ...
                    <tr class="">
                      ...
                      <td class="" style="text-align:center;"><?php echo round($sumValue201, 4); ?></td>
                      <th colspan="3" style="text-align: right;">Standard deviation</th>
                      <!-- <td></td> -->
                      <td colspan="2"><b><?php echo number_format($standarddeviationresult1, 0); ?></b></td>
